                ...
                <div className="resource-card" style={{
                  ...
                  <div style={{ position: "relative", zIndex: "1" }}>
                    <div className="resource-header mb-20">
                      ...
                      <h5 className="resource-title mb-15" style={{
                        fontSize: "22px",
                        fontWeight: "700",
                    ...
                    <div className="resource-description mb-25" style={{
                      fontSize: "16px",
                      color: "var(--body-text)",
                      lineHeight: "1.7",
                      flex: "1"
          ...
          {filteredResources.length === 0 && (
            <div className="text-center py-60">
              <div style={{
                ...
                <i className="fa-light fa-search" style={{ fontSize: "32px", color: "var(--theme-neutral)" }}></i>
              </div>
              <h4 style={{ color: "var(--body-heading)", marginBottom: "10px" }}>No resources found</h4>
              <p style={{ color: "var(--body-text)", fontSize: "16px" }}>Try adjusting your search criteria or category filter.</p>
            </div>
          )}
        </div>
