        ...
        <div className="section-wrapper pl-60 pr-60 pt-60">
          <div className="bostami-page-title-wrap mb-30">
            ...
            <p className="text-muted" style={{
              ...
              A curated collection of my favorite books and audiobooks that have shaped my thinking and growth
            </p>
          </div>
        </div>
          ...
          <div className="row mb-40">
            <div className="col-lg-4">
              <div className="search-box">
                <div style={{ position: "relative" }}>
                  <i className="fa-light fa-search" style={{
                    position: "absolute",
                    left: "16px",
                    top: "50%",
            ...
            <div className="col-lg-4">
              <div className="category-filter">
                <div style={{ position: "relative" }}>
                  <i className="fa-light fa-filter" style={{
                    position: "absolute",
                    left: "16px",
                    top: "50%",
                    transform: "translateY(-50%)",
            ...
            <div className="col-lg-4">
              <div className="type-filter">
                <div style={{ position: "relative" }}>
                  <i className="fa-light fa-book" style={{
                    position: "absolute",
                    left: "16px",
                    top: "50%",
                    transform: "translateY(-50%)",
                ...
                <div className="book-card" style={{
                  ...
                  <div style={{ position: "relative", zIndex: "1" }}>
                    <div className="book-header mb-20">
                        ...
                        <div className="d-flex align-items-center">
                          ...
                          <div>
                            <span className="badge" style={{
                              ...
                              padding: "6px 12px",
                              borderRadius: "20px",
                              backgroundColor: book.type === "Audiobook" ? "var(--theme-secondary)" : "var(--theme-primary)",
                              color: "white",
                              fontWeight: "600",
                              marginBottom: "8px",
                      ...
                      <h5 className="book-title mb-10" style={{
                        fontSize: "22px",
                        fontWeight: "700",
                      ...
                      <p className="book-author mb-15" style={{
                        fontSize: "16px",
                    ...
                    <div className="book-description mb-20" style={{
                      fontSize: "15px",
                      color: "var(--body-text)",
                      lineHeight: "1.6",
                      flex: "1"
          ...
          {filteredBooks.length === 0 && (
            <div className="text-center py-60">
              <div style={{
                ...
                <i className="fa-light fa-book" style={{ fontSize: "32px", color: "var(--theme-neutral)" }}></i>
              </div>
              <h4 style={{ color: "var(--body-heading)", marginBottom: "10px" }}>No books found</h4>
              <p style={{ color: "var(--body-text)", fontSize: "16px" }}>Try adjusting your search criteria or filters.</p>
            </div>
          )}
        </div>
